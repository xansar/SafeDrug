...
def parse_args():
    ...
    parser.add_argument("--momentum", type=float, default=0.95, help="weight decay")
    ...
    parser.add_argument("--n_layers", type=int, default=4, help="num of gnn layers")
    parser.add_argument("--med_sz", type=int, default=131, help="med size")
    parser.add_argument("--c", type=float, default=1., help="hyperbolic radius")
    ...
    parser.add_argument("--scale", type=int, default=0.1, help="embed init scale")
