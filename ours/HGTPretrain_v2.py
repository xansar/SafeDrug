...
from graph_construction import construct_graphs_v3, graph2hypergraph, desc_hypergraph_construction
...
def main():
    ...
    # adj_dict, cluster_matrix = construct_graphs_v3(cache_path, data_train, nums_dict=voc_size_dict, k=args.H_k,
    #                                             n_clusters=args.n_clusters)

    H = construct_graphs_v3(cache_path, data_train, nums_dict=voc_size_dict)

    # adj_dict, cluster_matrix = construct_graphs_v2(cache_path, data_train, nums_dict=voc_size_dict)
