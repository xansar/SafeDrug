...
resume_path = 'saved/SafeDrug/Epoch_49_TARGET_0.06_JA_0.5155_DDI_0.0611.model'
...
def eval(model, data_eval, voc_size, epoch):
    ...
    # ddi rate
    ddi_rate = ddi_rate_score(smm_record, path="../old_data/output/ddi_A_final.pkl")
...
def main():
    ...
    # load old_data
    data_path = "../old_data/output/records_final.pkl"
    voc_path = "../old_data/output/voc_final.pkl"

    ddi_adj_path = "../old_data/output/ddi_A_final.pkl"
    ddi_mask_path = "../old_data/output/ddi_mask_H.pkl"
    molecule_path = "../old_data/output/atc3toSMILES.pkl"
